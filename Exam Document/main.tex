...
Whats the difference between them: Prototype 1 and 2 are handmade maps while Prototype 4 is procedurally generated.
What is similar : The map assets, the horror aesthetic , the mechanics.
Will the addition of mechanics that allow the player to traverse the map in different ways
allow the use of bigger maps.
...
Adding enemy teleporters for the enemy to go to specific areas.
...
If enemy out of the map teleport the enemy back to starting position.
...
The minimap will ping the players position every few seconds which will guide the enemy to the player.
