...
The tutorial will include the narrator to help the player understand the story of the game. This will
also include improving the map to allow the player to improve on the mechanics while learning them. This
level will also require an improved enemy to show the player the actions and behavior of the enemy.
