...
to hide which causes another challenge. The player would need to remember where they
dropped their item.
...
\section{Genre}
Puzzle. The prototype is of the puzzle genre because the player needs to 
...
from the previous prototype. Although it is a continuation a new map was made because the new
map shows off more of the Hypothesis which is highlighting important game elements to allow
the player to identify them faster. The same tilemap was
...
to work in a 2d environment. Using this package enemies can easily move around the map.
