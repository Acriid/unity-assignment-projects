...
\begin{itemize}
    \item Add button to show what AI is doing.
    \item Add 2 more Goals
    \item Add crouch button to silence noise made
    \item Add some audio (footsteps for player and ai)
    \item Finish Document.
    \item Add quick reset.
    \item Add dev controls.
\end{itemize}
