...
Sound manager is being made while following the youtube video. Some changes from the video will be made. Audio
will only be added to the player and enemy footsteps, because

\section*{Reflection}

\section*{Small Checklist}
\begin{itemize}
    \item Add 2 more Goals (add lights to place too.)
    \item Finish Document.
\end{itemize}
...
downloaded audio from https://pixabay.com/sound-effects/search/footsteps/
downloaded from freesound_community, lordsonny and universfield
\end{document}