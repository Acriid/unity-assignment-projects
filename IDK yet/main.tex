...
To limit the player's vision through either a \gls{FOW} system or a field of view system
...
assignments easier. Through play testing it was found that the players did not trust 
the dialog system until they explored more of the \gls{map}
...
and goal where the goal is to escape the \gls{map}
or the system can just speak to the player.
\newline
